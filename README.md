...
**StrapDown.js** is already pretty advanced:
 ...
 3. *quick* and *secure*, thanks to *GitHub* and their great SSL support. Note : You can also use [https://cdn.combinatronics.com/Naereen/StrapDown.js/master/strapdown.min.js](https://cdn.combinatronics.com/Naereen/StrapDown.js/master/strapdown.min.js) to load the script from a quick and secure (HTTPS-aware) CDN.
 ...
 11. Note : You can also use [https://cdn.combinatronics.com/Naereen/StrapDown.js/master/strapdown.min.js](https://cdn.combinatronics.com/Naereen/StrapDown.js/master/strapdown.min.js) to have a true HTTPS support, by loading the script from a quick and secure (HTTPS-aware) CDN.
...
As the script is hosted on [GitHub](https://github.com/Naereen/StrapDown.js/), it can be loaded *quickly* and *securely* from [cdn.rawgit.com](https://cdn.combinatronics.com/Naereen/StrapDown.js/master/strapdown.min.js): [https://cdn.combinatronics.com/Naereen/StrapDown.js/master/strapdown.min.js](https://cdn.combinatronics.com/Naereen/StrapDown.js/master/strapdown.min.js)!
